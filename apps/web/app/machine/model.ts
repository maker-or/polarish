...
/**
 * This is the subset of WorkOS access-token claims that the machine needs to
 * map bearer auth to the existing Convex user and org records.
 */
export const WorkOSAccessTokenClaims = Schema.Struct({
	sub: Schema.String,
	org_id: Schema.optional(Schema.String),
});

export type WorkOSAccessTokenClaims = Schema.Schema.Type<
	typeof WorkOSAccessTokenClaims
>;
